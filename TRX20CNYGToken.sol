...
contract ERC20CNYG is ERC20, ERC20Burnable, Pausable, AccessControl {
    ...
    constructor(
        uint256 _feeStartAmount,
        uint256 _feeMaxAmount,
        uint256 _feeRate,
        address _feeCollector
    ) ERC20("CNYG Token", "CNYG") {
